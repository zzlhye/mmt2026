...
<div class="notice-register__container">
	...
	<div class="notice-register__title">사전교육 등록</div>
	<div class="notice-register__divider"></div>

	<form action="/preTraining/register" name="frm"
		class="notice-register__form" method="post">
		...
		<div class="notice-register__row">
			...
			<div class="notice-register__field">
				<input id="title" name="title" class="notice-register__input"
		...
		<div class="notice-register__row">
			...
			<label class="notice-register__label" for="category"> 대상 </label>
			...
			<div class="notice-register__field">
				...
				<div class="notice-register__select-wrap">
					...
					</select> <span class="notice-register__caret">▼</span>
		...
		<div class="notice-register__row">
			...
			<div class="notice-register__field">
				<textarea id="content" name="content"
					class="notice-register__textarea" placeholder="내용을 입력해주세요."></textarea>
			</div>
		...
		<div class="notice-register__row">
			...
			<div class="notice-register__field">
				...
				<div class="notice-register__file-row">
					...
					<label for="fileUpload" class="notice-register__file-btn">
						파일선택 </label> <input type="hidden" id="uploadCount" value="0"> <input
						id="fileUpload" type="file" class="notice-register__file-input"
						multiple>
		...
		<div class="notice-register__actions">
			...
			<button type="button"
				...
				onclick="registerPreTraining()">등록</button>

			<button type="button"
				class="notice-register__btn notice-register__btn--ghost"
				onclick="location.href='/preTraining/list'">취소</button>
